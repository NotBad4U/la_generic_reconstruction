...
\subsection{Checking Alethe arithmetic step}
...
The \tt{lia\_generic} still represent a challenge in our reconstruction compared to $\tt{la\_generic}$, because the coefficients are not provided by the solver in the trace i.e. \colorbox{orange!30}{$[a_1 \dots a_r]$} is empty.
