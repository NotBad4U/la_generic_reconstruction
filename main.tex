...
This process typically relies on techniques such as Simplex methods adapted for integers \cite{SRI:simplex:dpllt} and cutting-plane methods \todo[sm]{add reference} to establish the unsatisfiability of linear constraints.
...
We also intend to extend our work to support rational and real arithmetic, enabling verification of broader fragments of linear arithmetic (\changed{sm}{LRA}) theories.\todo[sm]{If I understand correctly, this mainly requires a representation of rationals in Lambdapi? Perhaps say more about this.}
