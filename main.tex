...
\changed{ac}{This new module enables the export of an Alethe proof, together with its \emph{input problem} parsed and elaborated by Carcara, into a Lambdapi file that can be independently verified using the Lambdapi compiler.}
